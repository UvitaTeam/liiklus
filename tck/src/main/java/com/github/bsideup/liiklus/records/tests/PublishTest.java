...
public interface PublishTest extends RecordStorageTestSupport {
    ...
    @Test
    default void testPublishWithoutTimestamp() throws Exception {
        ...
        assertThat(receivedRecord.getEnvelope())
                .as("envelope")
                .isEqualToIgnoringGivenFields(record, "timestamp");
    ...
    @Test
    default void testPublishWithTimestamp() throws Exception {
        var record = createEnvelope("key".getBytes(), Instant.now());
